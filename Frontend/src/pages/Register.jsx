...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/auth/otp-verification', { state: { userData: formData } });
    } catch (err) {
      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2 group">
            <div className="bg-green-500 w-10 h-10 flex items-center justify-center rounded-lg transition-transform duration-300 group-hover:scale-110 group-hover:rotate-[360deg]">
              <span className="text-white text-2xl">$</span>
            </div>
            <span className="text-white text-2xl font-semibold transition-colors duration-300 group-hover:text-green-400">Saving</span>
          </Link>
        ...
        <div className="bg-gray-800/50 backdrop-blur-md rounded-2xl p-8 border border-gray-700/50">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full py-3 px-4 rounded-xl text-white font-semibold bg-gray-700/50 hover:bg-gray-700 transition-all duration-300 flex items-center justify-center space-x-2"
            >
          ...
          <div className="mt-6 text-center">
            ...
            <Link to="/auth/login" className="text-green-500 hover:text-green-400 font-medium transition-colors">
              Sign in
            </Link>
          </div>
        </div>
